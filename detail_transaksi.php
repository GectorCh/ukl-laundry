...
<html>
    ...
    <body>    
            <table class="table table-striped">
                ...
                ?>
                    <h5 style="margin-left:5px;">Atas Nama : <?=$dt_transaksi['nama']?></h5>
            ...
            <h6 style="float:right;color:blue;"><?=$dt_transaksi['dibayar']?></h6>
            <h6>Kasir : <?=$_SESSION['nama']?></h6>
            <h7>Terimakasih telah menggunakan jasa kami</h7>
